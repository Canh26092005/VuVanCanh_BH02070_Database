...
namespace SaleManagementWinform
{
    ...
    {
        public Updatepurchase(string CustomerID, string PurchaseID, int PurchaseDate, string Code, int Quantity, int status, int active)
        {
            InitializeComponent();
        ...
        public Updatepurchase(string customerID, string purchaseID, string code, string purchaseDate, int quantity, int status, int active)
        {
            // Khởi tạo giá trị
        }
